This week we'll be working on the Boris Bikes exercise. The goal of this exercise is to introduce you to Object-Oriented Programming (OOP) and show you the very basics of Object-Oriented Design (OOD).
